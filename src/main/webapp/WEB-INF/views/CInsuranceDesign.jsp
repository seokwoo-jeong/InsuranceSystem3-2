	...
	<html>
		...
		<section class="site-section bg-light" id="contact-section"
			...
			<div class="container">
				...
				<form action=./InsuranceDesgin?action=car method="post"
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label> <input type="radio" class="option-input radio"
								value="Death" name="goodsSeparation" checked /> 사망&nbsp;
							</label> <label> <input type="radio" class="option-input radio"
								value="Injury" name="goodsSeparation" /> 부상&nbsp;
							</label> <label> <input type="radio" class="option-input radio"
								value="Aftereffect" name="goodsSeparation" /> 후유장해&nbsp;
							</label>
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label class="text-black" for="goodsGuaranteeLimit"> 대물
								배상 지급 한도 </label> <input type="text" name="goodsGuaranteeLimit"
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label class="text-black" for="goodsGuaranteeContent"> 대물
								배상 보장 내용 </label>
							<textarea name="goodsGuaranteeContent" id="goodsGuaranteeContent"
								cols="30" rows="7" class="form-control"
								placeholder="대물 배상에 대한 보장 내용을 작성하십시오."></textarea>
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label> <input type="radio" class="option-input radio"
								value="Death" name="personalSeparation" checked /> 사망&nbsp;
							</label> <label> <input type="radio" class="option-input radio"
								value="Injury" name="personalSeparation" /> 부상&nbsp;
							</label> <label> <input type="radio" class="option-input radio"
								value="Aftereffect" name="personalSeparation" /> 후유장해&nbsp;
							</label>
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label class="text-black" for="personalProvisionLimit">
								대인 배상 지급 한도 </label> <input type="text" name="personalProvisionLimit"
								class="form-control" id="numberOnly">
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label class="text-black" for="personalGuaranteeContent">
								대인 배상 보장 내용 </label>
							<textarea name="personalGuaranteeContent"
								id="personalGuaranteeContent" cols="30" rows="7"
								class="form-control" placeholder="대인 배상에 대한 보장 내용을 작성하십시오."></textarea>
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label> <input type="radio" class="option-input radio"
								value="SelfBodyAccident" name="selfVehicleSeparation" checked />
								자기 신체 사고&nbsp;
							</label> <label> <input type="radio" class="option-input radio"
								value="CarInjury" name="selfVehicleSeparation" /> 자동차 상해
							</label>
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label class="text-black" for="SubscriptionFeeForInjury">
								자기 차량 손해 부상 가입금액 </label> <input type="text"
								name="SubscriptionFeeForInjury" class="form-control"
								id="numberOnly">
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12">
							<label class="text-black"
								for="SubscriptionFeeForAccidentalInjuries"> 자기 차량 손해 사고
								후유장해의 가입금액 </label> <input type="text"
								name="SubscriptionFeeForAccidentalInjuries" class="form-control"
								id="numberOnly">
						</div>
					</div>
